...
# get imposter data:
train_data, _ = load_pan_dataset('../data/grant/background') # ignore unknown documents
train_labels, train_documents = zip(*train_data)

# get test data:
test_data, _ = load_pan_dataset('../data/grant/foreground') # ignore unknown documents
...
if not os.path.isdir(table_dir):
    os.mkdir(table_dir)
proba_df.to_csv(table_dir+'grant_test_proba.csv')
...
cm.savefig('../output/grant_verif_heatmap.pdf')
