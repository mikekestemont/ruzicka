...
f_results = open('../output/tables/latin_dev_o2_scores.csv', 'w')
...
for vector_space, metric in combs:
    ...
    dev_train_X, dev_train_y, dev_test_X, dev_test_y, dev_gt_scores = train_dev_split(dev_X, dev_y)
    ...
    test_train_X, test_train_y, test_test_X, test_test_y, test_gt_scores = train_dev_split(test_X, test_y)
    ...
    sb.plt.savefig("../output/latin_prec_rec_o2.pdf", bbox_extra_artists=(lgd,), bbox_inches='tight')
...
signif_df.to_csv('../output/tables/latin_dev_o2_signif.csv')
